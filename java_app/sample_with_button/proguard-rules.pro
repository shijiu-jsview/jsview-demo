...
#proguard from jsview
-keep public class com.qcode.jsview.JsView { *;}
-keep public class com.qcode.jsview.EventPack { *** put(...);}
-keep public class com.qcode.jsview.JsPromise { *;}
-keep public class com.qcode.jsview.JsView$ScreenShotCallback { *;}
