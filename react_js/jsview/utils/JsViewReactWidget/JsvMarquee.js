...
class JsvMarquee extends React.Component {
  ...
  _initKeyFrameAnim() {
    ...
    const name1 = `step1-${text_width}-${this.props.width}`;
    const step1 = `@keyframes ${name1} {
                from{
    ...
    const name2 = `step2-${text_width}-${this.props.width}`;
    const step2 = `@keyframes ${name2} {
                from{
  ...
  _startAnimation() {
    ...
    if (text_width > this.props.width) {
      ...
      const overflowWidth = text_width;
                     ...
                     onAnimationEnd={
                         () => {
                           ...
                           if (this.state.count % 2 === 0) {
                             const duration = Math.ceil(this.props.width / 60);
                             this.setState({
