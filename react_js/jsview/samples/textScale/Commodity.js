...
import JsvScaleTextBox from "../jsview-utils/JsViewReactWidget/JsvScaleTextBox";
...
const data = {
  ...
  small_images: {
    string: [
      "//img.alicdn.com/i4/2207313464483/O1CN012eyYoJ1izGAxjoRho_!!2207313464483.jpg",
      "//img.alicdn.com/i4/2207313464483/O1CN01LIIJa51izG96sZ93h_!!2207313464483.jpg",
      "//img.alicdn.com/i1/2207313464483/O1CN01JIRuN01izGAjgtdku_!!2207313464483.jpg",
      "//img.alicdn.com/i4/2207313464483/O1CN017mQtBl1izGAdzUv7c_!!2207313464483.jpg",
    ],
  },
  sub_title: "",
  ...
  volume: 3656,
  white_image:
    "https://img.alicdn.com/bao/uploaded/O1CN01lbIdM81izGArrWvxf_!!2-item_pic.png",
...
class Commodity extends React.Component {
  ...
  render() {
    ...
    const couponAmount = `${data.coupon_amount}`;
    const couponWidth =
      data.coupon_amount === 0 ? 0 : 16 + 57 + 14 * couponAmount.length;
    let volume;
    ...
    const volumeWidth = 20 + 70 + 15 * volume.length;
    const radius = 8;
    const draw_item = (
      <div>
        <JsvScaleTextBox
          ...
          definitionScale={this.state.boxScale}
        >
          <div
            debug_name__="frame_bottom"
            style={{
              width: 320,
              height: 320,
            ...
            >
              <div
                ...
                style={{
                  width: 8,
                  height: 36,
                  backgroundImage: `url(${couponLeft})`,
                }}
              />
              <div
                debug_name__="round1"
                style={{
                  width: couponWidth - 16,
                  height: 36,
              ...
              <div
                ...
                style={{
                  width: 8,
                  height: 36,
                  backgroundImage: `url(${couponRight})`,
                  left: couponWidth - 8,
                }}
              />
              <div
                debug_name__="roundText"
                style={{
                  width: couponWidth,
                  height: 36,
                  color: "#FFFFFF",
