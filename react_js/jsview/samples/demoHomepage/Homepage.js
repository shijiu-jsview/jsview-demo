 ...
 * @LastEditTime: 2021-04-22 18:21:41
      ...
      <React.Fragment>
        ...
        </div>
        {
          this.state.quitWindow ?
            <div>
              <JsvTouchContainer style={{ left: 0, top: 0, width: 1920, height: 1080 }}
                onClick={() => { }}
                direction={JsvTouchContainer.DIRECTION_DISABLE}></JsvTouchContainer>
