...
class DivLayout extends React.Component {
  render() {
    const imageShowWidth = 80;
    const imageShowHeight = 64;
    const clipWidth = 50;
    const clipHeight = 40;
    ...
    return (<div id='layout-root' style={this.props.style}>
                <div style={{ top: 0 }}>
                    ...
                    <div style={{ top: titleHeight,
                      width: imageShowWidth + 4,
                      height: imageShowHeight + 4,
                ...
                <div style={{ top: imageShowHeight + titleHeight + 4 }}>
                    ...
                    <div style={{ top: titleHeight,
                      ...
                      height: imageShowHeight + 4,
                      backgroundColor: 'rgba(0, 255, 0, 1)' }}>
                        <div key="clipArea" style={{ left: 2,
                          top: 2,
                          width: clipWidth,
                          height: clipHeight,
                          overflow: "hidden" }}>
                            <div style={{ width: imageShowWidth,
                              height: imageShowHeight,
                              backgroundImage: `url(${testImgPath})` }}/>
                        </div>
                    </div>
                ...
                <div style={{ top: (imageShowHeight + titleHeight + 4) * 2 }}>
                    ...
                    <div style={{ top: titleHeight,
                      ...
                      height: imageShowHeight + 4,
                      backgroundColor: 'rgba(0, 255, 0, 1)' }}>
                        <div key="clipArea" style={{ top: 2 + (imageShowHeight - clipHeight),
                          left: 2 + (imageShowWidth - clipWidth),
                          width: clipWidth,
                          height: clipHeight,
                          overflow: "hidden" }}>
                            <div style={{ top: -((imageShowHeight - clipHeight)),
                              left: -(imageShowWidth - clipWidth),
                              width: imageShowWidth,
                              height: imageShowHeight,
                              backgroundImage: `url(${testImgPath})` }}/>
                        </div>
