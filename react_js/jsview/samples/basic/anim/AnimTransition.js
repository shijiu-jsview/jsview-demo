  ...
  _changeState=() => {
    setTimeout(() => {
      ...
      this.setState({
        ...
        transform: 'translate3d(80px,0px,0) scale3d(2,2,1.0) rotate3d(0, 0, 1, 360deg)',
      ...
      setTimeout(() => {
        this.setState({
          ...
          transform: 'translate3d(30px,0px,0) scale3d(0.2,0.2,1.0) rotate3d(0, 0, 1, -360deg)',
          transformOrigin: 'center center'
        });
      }, 3000);
    }, 3000);
    ...
    return <div id='layout-root' style={this.props.style}>
              ...
              <div style={{ top: 140, width: 240, height: 160, backgroundColor: "rgba(0, 0, 255, 0.5)" }}>
                ...
                <div style={{ ...blockStyle,
                  ...
                  transformOrigin: this.state.transformOrigin }}>移动缩放旋转</div>
                <div style={{ ...blockStyle,
                  top: 140,
                  transition: "transform 2.5s linear 0.5s",
                  transformOrigin: 'center center',
                  transform: this.state.transformTranslate }}>移动</div>
                <div style={{ ...blockStyle,
                  left: 140,
                  top: 20,
                  transition: "transform 2.5s linear 0.5s",
                  transformOrigin: 'center center',
                  transform: this.state.transformScale }}>缩放</div>
                <div style={{ ...blockStyle,
                  top: 75,
                  left: 140,
                  transition: "transform 2.5s linear 0.5s",
                  transformOrigin: 'center center',
                  transform: this.state.transformRotate }}>旋转</div>
              </div>
            </div>;
  }
