...
class NormalVideo extends FocusBlock {
  constructor(props) {
    super(props);
  ...
  seek(time) {
    try {
      ...
      // console.log(e, 'NormalVideo is not ready.')
    }
  }
...
2.支持ObjectFit调整`}</div>
  ...
  componentWillUnmount() {
    console.log("NormalVideo App componentWillUnmount in");
  }

  componentDidMount() {
    console.log("NormalVideo App componentDidMount in");
  }
