...
import { FdivWrapper, SimpleWidget, HORIZONTAL } from "../jsview-utils/jsview-react/index_widget";
import "./homepage.css";
...
class Home extends FdivWrapper {
  ...
  _RenderFocus(item) {
    return (
            <div>
                ...
                <div style={{ left: (this.ItemWidth - 248) / 2,
                  top: 185,
                  width: 248,
                  height: 34,
                  lineHeight: 34,
  ...
  _RenderItem(item) {
    return (
            <div >
                <div style={{ left: (this.ItemWidth - 208) / 2,
                  top: (this.ItemHeight - 130) / 2,
                  width: 208,
                  height: 130,
                  backgroundImage: `url(${shadow_small_img})` }}/>
                <div style={{ left: (this.ItemWidth - 202) / 2,
