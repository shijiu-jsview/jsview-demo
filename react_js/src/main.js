...
function startApp(confirm_entry) {
	if(!!window.JsView) {
		...
		if (window.JsView.CodeRevision !== 513 /* Native引擎版本(由APK启动参数 CORE 决定) */
				|| window.Forge.Version !== "1.0.710" /* JS引擎版本(由APK启动参数 ENGINEJS 决定) */) {
			console.warn("Warning: JsView Engine version miss matched, some effect will be lost");
			/* Engine js 710版本地址: http://cdn.release.51vtv.cn/forge_js/master/JsViewES6_react_r710.jsv.06f08908.js */
		}
