...
class GameOver extends FocusBlock {
    ...
    renderContent() {
        ...
        let charSprite = result==="complete"?this._Theme.content.charSprite:this._Theme.content.charFailedSprite;
        let btn = result === "complete" ? this._Theme.content.continueBtn:this._Theme.content.replayBtn;
        return (
