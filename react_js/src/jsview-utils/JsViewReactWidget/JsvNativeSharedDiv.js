...
class JsvNativeSharedDiv extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        ...
        let new_style = nextProps.style;
        return (this._CurrentStyle.left !== new_style.left
    ...
    render() {
        ...
        if (this._JsvMainView === null) {
            ...
            const seeThroughTexture = ForgeExtension.TextureManager.GetColorTexture("rgba(0,0,0,0)");
            const textureSetting = new Forge.TextureSetting(seeThroughTexture, null, null, false);
        ...
        // 更新宽高
        this._JsvMainView.ResetLayoutParams({width: this.props.style.width, height: this.props.style.height});
        ...
        return (
            <div jsv_innerview={this._InnerViewId} children={this.props.children}
