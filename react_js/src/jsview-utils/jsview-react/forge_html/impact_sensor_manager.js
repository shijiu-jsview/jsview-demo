...
class DragImpactSensor extends ElementImpactSensor {
    constructor(slidePilePoints, element2, callback) {
        super(slidePilePoints, element2, callback);
    ...
    TestCollision() {
        ...
        let ele_transform = getTransform(this._Element2);
        var intersected = gjk.intersect(this._Element1.slice(0, 1), ele_transform);
        var intersected1 = gjk.intersect(this._Element1.slice(1, 2), ele_transform);
        var intersected2 = gjk.intersect(this._Element1.slice(2, 3), ele_transform);
        var intersected3 = gjk.intersect(this._Element1.slice(3, 4), ele_transform);
...
class ImpactSensor extends ElementImpactSensor {
    constructor(element1, element2, callback) {
        super(element1, element2, callback)
    }
...
class ImpactSensorManager {
    ...
    StartTrace(layout_view1, layout_view2, callback) {
        let sensor = new ImpactSensor(layout_view1.Element, layout_view2.Element, callback);
