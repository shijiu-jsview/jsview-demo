...
class LayoutParamsBase {
	...
	Clone() {
		var new_layout_params = new LayoutParamsBase(null);
...
class LayoutParams extends Forge.LayoutParamsBase {
	...
	constructor(settings)
	{
		...
		if (settings instanceof Forge.RectArea)
			settings = {x:settings.x, y:settings.y, width:settings.width, height:settings.height};
