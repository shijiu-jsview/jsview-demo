...
class PageTheme {
    static get() {
        return {
            "MainPage": {
                bgStyle: {
                    width: 1920, height: 1080, backgroundImage: `url(${backgroundImg})`,
                ...
                btn1:{
                    style:{
                        ...
                        fontSize:30,color:"#151e77",lineHeight:"60px",textAlign:"center",verticalAlign:"middle"
                    },
                    focusStyle:{
                        left:1403,top:33,width:200,height:60,
            ...
            "NineSquared": {
                ...
                goBtn:{
                    ...
                    font:{
                        ...
                        fontSize:32,color:"#ffffff",lineHeight:"40px",textAlign:"center",verticalAlign:"middle"
                    }
                },
            ...
            tipsInfo:{
                ...
                fontSize:24,color:"#ffffff",lineHeight:"60px",textAlign:"center",verticalAlign:"middle"
            }
        }
    }
}
