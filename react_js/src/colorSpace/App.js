    ...
    renderContent() {
        return (
            <div style={{width: 1920, height: 1080, backgroundColor: "#005500"}}>
                ...
                <img style={{left: 0, top: 300, width: 200, height: 200, borderRadius: '15px 15px 15px 15px'}} jsv_img_color_space={"RGB_565"} src={bmpDemo}/>
                <img style={{left: 220, top: 300, width: 200, height: 200, borderRadius: '15px 15px 15px 15px'}} jsv_img_color_space={"RGB_565"} src={jpegDemo}/>
                <img style={{left: 440, top: 300, width: 200, height: 200, borderRadius: '15px 15px 15px 15px'}} jsv_img_color_space={"RGB_565"} src={jpgDemo}/>
                <img style={{left: 660, top: 300, width: 200, height: 200, borderRadius: '15px 15px 15px 15px'}} jsv_img_color_space={"RGB_565"} src={pngDemo}/>
                <img style={{left: 880, top: 300, width: 200, height: 200, borderRadius: '15px 15px 15px 15px'}} jsv_img_color_space={"RGB_565"} src={pngNoAlphaDemo}/>
