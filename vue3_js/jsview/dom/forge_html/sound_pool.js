 ...
 * @LastEditTime: 2020-09-21 13:47:49
  ...
  class SoundPool {
    ...
    play(soundId, leftVolume, rightVolume, priority, loop, rate) {
      if (this._SoundBufferMap[soundId]) {
        ...
        const stream = new Stream(audioContext, bufferSource, gainNode);
